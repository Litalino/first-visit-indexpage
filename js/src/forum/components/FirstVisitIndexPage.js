...
export default class FirstVisitIndexPage extends Page {
    oncreate(vnode) {
        ...
        app.setTitle(app.translator.trans('first-visit-indexpage.forum.app-title'));
        app.setTitleCount(0);
    }
                ...
                m('.sideNavContainer', [
                    m('.IndexPage-results.sideNavOffset',
                        m('div', { className: 'body-post' }, [
                            ...
                            m('div',
                                { className: 'outer make-center' },
                                m('div',
                                    { className: 'inner make-center' },
                                    m('input', { type: 'checkbox', id: 'agreeRules' }),
                                    app.translator.trans('first-visit-indexpage.forum.accept-rules')
                                )
                            ),
                            m('button',
                                {
                                    ...
                                    onclick: function () {
                                        if (document.getElementById('agreeRules').checked) {
                                            ...
                                            alert(app.translator.trans('first-visit-indexpage.forum.alert-message'));
                                        }
                                    },
                                },
